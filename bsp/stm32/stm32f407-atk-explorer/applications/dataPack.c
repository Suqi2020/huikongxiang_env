...
void  devIDFlashRead()
{
	  ...
	  rt_strcpy(dev[chanl.cirCula].name,"接地环流");
	  ...
	  rt_strcpy(dev[chanl.partDischag].name,"局放监控");
	  ...
	  rt_strcpy(dev[chanl.pressSettl].name,"沉降仪");
	  ...
	  rt_strcpy(dev[chanl.threeAxis].name,"三轴测振仪");
